<script lang="ts">
	...
	const panelClassName = $derived(
		isAvatarView
			? 'pointer-events-auto w-full max-w-[68rem] border-[#2d2a26] bg-[linear-gradient(180deg,rgba(255,252,246,0.98),rgba(247,239,228,0.98))] text-[#2d2a26]'
			: 'pointer-events-auto w-full max-w-[44rem] border-[#2d2a26] bg-[linear-gradient(180deg,rgba(255,252,246,0.97),rgba(248,241,230,0.97))] text-[#2d2a26]'
	);
...
>
	<StudioPanel tone="paper" className={panelClassName}>
		<div
